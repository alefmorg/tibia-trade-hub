    ...
    <div className="min-h-screen">
      ...
      <div className="border-b border-border bg-card/50">
        <div className="container py-4 flex flex-col sm:flex-row items-center gap-3">
          ...
          <Button className="bg-secondary text-foreground border border-border hover:bg-secondary/80 h-11 px-6" onClick={() => {}}>
          ...
          <aside className="hidden lg:block w-64 shrink-0 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {categories.map(cat => (
                  <FilterChip key={cat} label={cat} active={false} onClick={() => {}} />
                ))}
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {battleEyeTypes.map(be => (
                  <FilterChip key={be} label={be} active={false} color={be === "Amarelo" ? "bg-warning" : "bg-success"} onClick={() => {}} />
                ))}
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {continents.map(c => (
                  <FilterChip key={c} label={c} active={false} onClick={() => {}} />
                ))}
              </div>
            </div>
          </aside>
