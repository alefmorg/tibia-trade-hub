  ...
  <Html lang="pt-BR" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Clique no botão abaixo para entrar no {siteName}. Este link é válido por tempo limitado.
        </Text>
        <Button style={button} href={confirmationUrl}>Entrar no {siteName}</Button>
        <Text style={footer}>
